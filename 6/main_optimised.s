...
f:
	...
	push	rbp
	mov	rbp, rsp
	movsd	xmm4, xmm0  # первый аргумент функции a (-8[rbp]) замененён на xmm4
	movsd	xmm5, xmm1  # второй аргумент функции b (-16[rbp]) замененён на xmm5
	movsd	xmm6, xmm2  # третий аргумент функции x (-24[rbp]) замененён на xmm6
	movsd	xmm0, xmm5
	mulsd	xmm0, xmm6
	mulsd	xmm0, xmm6
	mulsd	xmm0, xmm6
